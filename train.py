...
def main():
    ...
    train_examples, dev_examples, eval_examples, label_list = load_CLINC150_with_specific_domain('banking', 1, args.seed, augment=args.do_data_aug)
...
if __name__ == "__main__":
    ...
    '''
# CUDA_VISIBLE_DEVICES=7 python -u train.py --task_name rte --do_train --do_lower_case --num_train_epochs 200 --data_dir '' --output_dir '' --train_batch_size 15 --eval_batch_size 15 --learning_rate 5e-6 --max_seq_length 20 --seed 42 --do_data_aug
