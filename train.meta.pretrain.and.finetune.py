                ...
                if iter_co % len(train_dataloader)==0:
                    ...
                    for idd, dev_or_test_dataloader in enumerate([dev_dataloader, eval_dataloader]):
                        ...
                        for input_ids, input_mask, segment_ids, label_ids in dev_or_test_dataloader:
                            ...
                            biased_similarity_scores_pretrain = raw_similarity_scores#+bias_finetune.view(-1, raw_similarity_scores.shape[1])
                            ...
                            alpha=0.9
                            biased_similarity_scores = (1-alpha)*biased_similarity_scores_pretrain+alpha*biased_similarity_scores +bias_finetune.view(-1, raw_similarity_scores.shape[1])
