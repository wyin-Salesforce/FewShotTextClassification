...
pretrain_model_dir = 'facebook/bart-large-mnli' #'roberta-large' , 'roberta-large-mnli', 'bert-large-uncased'
...
def main():
    ...
    train_examples, dev_examples, eval_examples, label_list = load_CLINC150_with_specific_domain('banking', 1, augment=args.do_data_aug)
    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                loss = outputs[0]#loss_fct(logits.view(-1, num_labels), label_ids.view(-1))
...
if __name__ == "__main__":
    ...
    '''
# CUDA_VISIBLE_DEVICES=6 python -u train.Bart.py --task_name rte --do_train --do_lower_case --num_train_epochs 200 --data_dir '' --output_dir '' --train_batch_size 5 --eval_batch_size 5 --learning_rate 5e-6 --max_seq_length 20 --seed 42 --do_data_aug
