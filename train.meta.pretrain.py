...
if __name__ == "__main__":
    ...
    '''
# CUDA_VISIBLE_DEVICES=0 python -u train.meta.pretrain.py --task_name rte --do_train --do_lower_case --data_dir '' --output_dir '' --train_batch_size 5 --eval_batch_size 5 --learning_rate 5e-6 --max_seq_length 20 --seed 42 --kshot 3 --meta_epochs 3 --DomainName 'banking'
